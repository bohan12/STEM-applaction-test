<html>
	...
	<link href="../CSS/csscss.css" media="screen" rel="stylesheet" type="text/css"/>
...
<form action="secondpages.php">
	<button type="submit" formaction = "secondpages.php" style="margin-bottom: 100px 0px">Continue to next page ►</button>
</form>
